...
**At a glance:** **12 done & verified** · **2 code-complete (external blocker)** · **4 in progress** · **1 hygiene-done / rest-deferred** · **1 borderline-safe** · **2 not started / deferred**. Overall active backlog **~88%** (~84% including the deferred AUTH-01). Re-verified: API+web typecheck clean, `test:source` 51/51, web tests 9/9. _(In-progress finalization underway — DATA-02 ✅ + PERF-01 ✅ done 2026-06-30.)_

### ✅ Done & verified — 100% (12)
...
### 🚧 In progress — real remaining work (4)
