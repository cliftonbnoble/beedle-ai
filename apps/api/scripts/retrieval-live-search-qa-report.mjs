...
const reportName = process.env.RETRIEVAL_LIVE_SEARCH_QA_REPORT_NAME || "retrieval-live-search-qa-report.json";
const markdownName = process.env.RETRIEVAL_LIVE_SEARCH_QA_MARKDOWN_NAME || "retrieval-live-search-qa-report.md";
...
async function main() {
  ...
  console.log(`Retrieval live search QA JSON report written to ${jsonPath}`);
  console.log(`Retrieval live search QA Markdown report written to ${mdPath}`);
}
